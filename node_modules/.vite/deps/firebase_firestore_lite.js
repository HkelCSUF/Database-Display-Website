...
async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, r) {
  const n = __PRIVATE_debugCast(e), { request: i, J: s, parent: o } = (function __PRIVATE_toRunAggregationQueryRequest(e2, t2, r2, n2) {
    const { K: i2, parent: s2 } = __PRIVATE_toQueryTarget(e2, t2), o2 = {}, a2 = [];
    let u2 = 0;
    ...
    return t2.U || // Do not include implicit order-bys for aggregate queries.
    (t2.U = __PRIVATE__queryToTarget(t2, e2.explicitOrderBy)), t2.U;
  })(t), r);
...
function collectionGroup(e, t) {
  if (e = __PRIVATE_cast(e, Firestore), __PRIVATE_validateNonEmptyArgument("collectionGroup", "collection id", t), t.indexOf("/") >= 0) throw new FirestoreError(d.INVALID_ARGUMENT, `Invalid collection ID '${t}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
  return new Query(
    e,
    /* converter= */
    null,
...
var __PRIVATE_ArrayUnionFieldValueImpl = class ___PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), r = this.H.map(((e2) => __PRIVATE_parseData(e2, t))), n = new __PRIVATE_ArrayUnionTransformOperation(r);
    return new FieldTransform(e.path, n);
  }
  isEqual(e) {
    return e instanceof ___PRIVATE_ArrayUnionFieldValueImpl && deepEqual(this.H, e.H);
  }
};
var __PRIVATE_ArrayRemoveFieldValueImpl = class ___PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), r = this.H.map(((e2) => __PRIVATE_parseData(e2, t))), n = new __PRIVATE_ArrayRemoveTransformOperation(r);
    return new FieldTransform(e.path, n);
  }
  isEqual(e) {
    return e instanceof ___PRIVATE_ArrayRemoveFieldValueImpl && deepEqual(this.H, e.H);
  }
};
var __PRIVATE_NumericIncrementFieldValueImpl = class ___PRIVATE_NumericIncrementFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = new __PRIVATE_NumericIncrementTransformOperation(e.serializer, toNumber(e.serializer, this.Y));
    return new FieldTransform(e.path, t);
  }
  isEqual(e) {
    return e instanceof ___PRIVATE_NumericIncrementFieldValueImpl && (this.Y === e.Y || Number.isNaN(this.Y) && Number.isNaN(e.Y));
  }
};
var __PRIVATE_NumericMinimumFieldValueImpl = class ___PRIVATE_NumericMinimumFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = new __PRIVATE_NumericMinimumTransformOperation(e.serializer, toNumber(e.serializer, this.Y));
    return new FieldTransform(e.path, t);
  }
  isEqual(e) {
    return e instanceof ___PRIVATE_NumericMinimumFieldValueImpl && (this.Y === e.Y || Number.isNaN(this.Y) && Number.isNaN(e.Y));
  }
};
var __PRIVATE_NumericMaximumFieldValueImpl = class ___PRIVATE_NumericMaximumFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = new __PRIVATE_NumericMaximumTransformOperation(e.serializer, toNumber(e.serializer, this.Y));
    return new FieldTransform(e.path, t);
  }
  isEqual(e) {
    return e instanceof ___PRIVATE_NumericMaximumFieldValueImpl && (this.Y === e.Y || Number.isNaN(this.Y) && Number.isNaN(e.Y));
  }
};
...
function __PRIVATE_parseQueryValue(e, t, r, n = false) {
  return __PRIVATE_parseData(r, e.createContext(n ? 4 : 3, t));
}
...
function query(e, t, ...r) {
  ...
  t instanceof AppliableConstraint && n.push(t), n = n.concat(r), (function __PRIVATE_validateQueryConstraintArray(e2) {
    ...
    if (t2 > 1 || t2 > 0 && r2 > 0) throw new FirestoreError(d.INVALID_ARGUMENT, "InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.");
  })(n);
...
function __PRIVATE_newQueryBoundFromDocOrFields(e, t, r, n) {
  if (r[0] = getModularInstance(r[0]), r[0] instanceof DocumentSnapshot) return (function __PRIVATE_newQueryBoundFromDocument(e2, t2, r2, n2, i) {
    if (!n2) throw new FirestoreError(d.NOT_FOUND, `Can't use a DocumentSnapshot that doesn't exist for ${r2}().`);
    const s = [];
    for (const r3 of __PRIVATE_queryNormalizedOrderBy(e2)) if (r3.field.isKeyField()) s.push(__PRIVATE_refValue(t2, n2.key));
      ...
      if (__PRIVATE_isServerTimestamp(e3)) throw new FirestoreError(d.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + r3.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
      if (null === e3) {
  ...
  })(e._query, e.firestore._databaseId, t, r[0]._document, n);
  {
    ...
    return (function __PRIVATE_newQueryBoundFromFields(e2, t2, r2, n2, i2, s) {
      ...
      if (i2.length > o.length) throw new FirestoreError(d.INVALID_ARGUMENT, `Too many arguments provided to ${n2}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
      const a = [];
      for (let s2 = 0; s2 < i2.length; s2++) {
        const u = i2[s2];
        if (o[s2].field.isKeyField()) {
          if ("string" != typeof u) throw new FirestoreError(d.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${n2}(), but got a ${typeof u}`);
          if (!__PRIVATE_isCollectionGroupQuery(e2) && -1 !== u.indexOf("/")) throw new FirestoreError(d.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${n2}() must be a plain document ID, but '${u}' contains a slash.`);
          const r3 = e2.path.child(ResourcePath.fromString(u));
          if (!DocumentKey.isDocumentKey(r3)) throw new FirestoreError(d.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by documentId(), the value passed to ${n2}() must result in a valid document path, but '${r3}' is not because it contains an odd number of segments.`);
...
var __PRIVATE_ExponentialBackoff = class {
  constructor(t, e, i = 1e3, a = 1.5, r = 6e4) {
    this.t = t, this.timerId = e, this.i = i, this.o = a, this.h = r, this.u = 0, this.l = null, /** The last backoff attempt, as epoch milliseconds. */
  ...
  A(t) {
    ...
    a > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${a} ms (base delay: ${this.u} ms, delay with jitter: ${e} ms, last attempt: ${i} ms ago)`), this.l = this.t.enqueueAfterDelay(this.timerId, a, (() => (this._ = Date.now(), t()))), // Apply backoff factor to determine next delay and ensure it is within
    // bounds.
...
function getAggregate(t, e) {
  const i = __PRIVATE_cast(t.firestore, Firestore), a = __PRIVATE_getDatastore(i), r = __PRIVATE_mapToArray(e, ((t2, e2) => new __PRIVATE_AggregateImpl(e2, t2.aggregateType, t2._internalFieldPath)));
  return __PRIVATE_invokeRunAggregationQueryRpc(a, t._query, r).then(((e2) => (function __PRIVATE_convertToAggregateQuerySnapshot(t2, e3, i2) {
    const a2 = new __PRIVATE_LiteUserDataWriter(t2), r2 = new AggregateQuerySnapshot(e3, a2, i2);
    return r2;
  })(i, t, e2)));
}
function sum(t) {
...
var __PRIVATE_TransactionRunner = class {
  constructor(t, e, i, a, r) {
    this.asyncQueue = t, this.datastore = e, this.options = i, this.updateFunction = a, this.deferred = r, this.I = i.maxAttempts, this.P = new __PRIVATE_ExponentialBackoff(
      this.asyncQueue,
      "transaction_retry"
...
var DelayedOperation = class _DelayedOperation {
  constructor(t, e, i, a, r) {
    this.asyncQueue = t, this.timerId = e, this.targetTimeMs = i, this.op = a, this.removalCallback = r, this.deferred = new __PRIVATE_Deferred(), this.then = this.deferred.promise.then.bind(this.deferred.promise), // It's normal for the deferred promise to be canceled (due to cancellation)
  ...
  static createAndSchedule(t, e, i, a, r) {
    const o = Date.now() + i, h = new _DelayedOperation(t, e, o, a, r);
    return h.start(i), h;
  }
  /**
...
var __PRIVATE_AsyncQueueImpl = class {
  ...
  enqueueAfterDelay(t, e, i) {
    ...
    const a = DelayedOperation.createAndSchedule(this, t, e, i, ((t2) => this.G(t2)));
...
var Transaction = class {
  ...
  update(t, e, i, ...a) {
    const r = __PRIVATE_validateReference(t, this._firestore);
    let o;
    return o = "string" == typeof (e = getModularInstance(e)) || e instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(this._dataReader, "Transaction.update", r._key, e, i, a) : __PRIVATE_parseUpdateData(this._dataReader, "Transaction.update", r._key, e), this._transaction.update(r._key, o), this;
  }
  /**
   * Deletes the document referred to by the provided {@link DocumentReference}.
   *
...
function runTransaction(t, e, i) {
  ...
  })(), a, r, ((i2) => e(new Transaction(t, i2))), o).V(), o.promise;
}
