...
export default function LoginPage() {
    ...
    const [showGoogleTodoModal, setShowGoogleTodoModal] = useState(false);
    const { currentUser, logIn, signUp, logInWithGoogle, logOut } = useAuth(); //important hook to get auth functions and current user
    ...
    // function handleGoogleLogin() { //comment this out for lab 11 task
    //     setShowGoogleTodoModal(true);
    // }

    // TODO: Lab 11 task - implement Google sign in with Firebase.
    // Hint: import GoogleAuthProvider and signInWithPopup from Firebase Auth.
    ...
    async function handleGoogleLogin() {
        ...
        try {
            await logInWithGoogle(); //this is a function you will import from useAuth().
            setStatus("You are logged in.");
            navigate("/");
        } catch (authError) {
            setError(getAuthErrorMessage(authError));
            ...
            <>
                <section className="card shadow-sm mb-4 auth-card">
                    <div className="card-body">
                        ...
                        <p className="mb-3">You are signed in to Movies Portal.</p>
                ...
                <div className="card-body">
                    <div className="d-flex flex-column flex-md-row justify-content-between gap-3 mb-4">
                        <div>
                            ...
                            <p className="mb-0 text-muted">Use your email and password. Google sign in is a lab task.</p>
                        </div>
                        ...
                        <div className="modal-dialog modal-dialog-centered">
                            <div className="modal-content">
                                <div className="modal-header">
                                    ...
                                    <button className="btn-close" type="button" aria-label="Close" onClick={() => setShowGoogleTodoModal(false)}></button>
                                </div>
                                <div className="modal-body">
                                    <p className="mb-0">Google sign in has not been implemented yet. Students will add Firebase Google provider logic for this feature.</p>
                                </div>
                                <div className="modal-footer">
                                    <button className="btn btn-primary navbar-theme-color" type="button" onClick={() => setShowGoogleTodoModal(false)}>Close</button>
                                </div>
                            </div>
                        </div>
                    </div>
